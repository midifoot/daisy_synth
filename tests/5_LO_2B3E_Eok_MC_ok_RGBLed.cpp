...
int main(void) {
    ...
    // ==========================================
    daisy::RgbLed rgb;
    // Init parameters: Red Pin, Green Pin, Blue Pin, Invert Logic (false for Common Cathode)
    ...
    while(1) {
        ...
        if (needsDisplayUpdate) {
            ...
            // A robust buffer declared freshly for drawing text
            char valStr[40]; 
